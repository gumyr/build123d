...
save_model([face, location_symbol(loc)], "location-example-01", {"axes": True, "reset_camera": "dimetric"})


plane = Plane.XZ
face = plane * Rectangle(1, 2)
save_model([face, plane_symbol(plane)], "location-example-07", {"axes": True, "reset_camera": "dimetric"})
...
save_model([face, location_symbol(loc), box], "location-example-02", {"axes": True, "reset_camera": "dimetric"})


loc = Location((0.1, 0.2, 0.3), (10, 20, 30))
face = loc * Rectangle(1,2)
box = Plane(loc) * Rot(Z=80) * Box(0.2, 0.2, 0.2)
save_model([face, location_symbol(loc), box], "location-example-03", {"axes": True, "reset_camera": "dimetric"})


loc = Location((0.1, 0.2, 0.3), (10, 20, 30))
face = loc * Rectangle(1,2)
box = loc * Rot(20, 40, 80) * Box(0.2, 0.2, 0.2)
save_model([face, location_symbol(loc), box], "location-example-04", {"axes": True, "reset_camera": "dimetric"})
...
save_model([face, location_symbol(loc), box, local_loc], "location-example-05", {"axes": True, "reset_camera": "dimetric"})
...
local_loc.color = (0, 1, 1)
save_model([face, location_symbol(loc), box, local_loc], "location-example-06", {"axes": True, "reset_camera": "dimetric"})