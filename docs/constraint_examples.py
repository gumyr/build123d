...
svg.add_layer("m1", line_color=0xD62828, line_type=LineType.ISO_DASH_SPACE)
svg.add_layer("m2", line_color=0xFCBF49, line_type=LineType.ISO_DASH_SPACE)
svg.add_layer("connector", line_color=0xF77F00)
svg.add_layer("comb", line_color=0xACACAC)
svg.add_shape(axes2)
svg.add_shape(m1, "m1")
svg.add_shape(m2, "m2")
